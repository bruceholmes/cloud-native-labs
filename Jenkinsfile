            ...
            script {
                openshift.withCluster {
                    openshift.withProject('user8') {
                        ...
                        openshift.tag("coolstore/gateway:latest", "user8/gateway-canary:latest")
                    }
                }
            }
        }
        ...
        script {
            openshift.withCluster() {
                openshift.withProject('user8') {
                    ...
                    openshift.tag("user8/gateway-canary:latest", "user8/gateway:latest")
